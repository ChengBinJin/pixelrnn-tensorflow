...
tf.flags.DEFINE_integer('batch_size', 4, 'batch sizes, default: 100')
...
tf.flags.DEFINE_integer('epochs', 4, 'number of epochs, default: 400')
...
tf.flags.DEFINE_integer('sample_batch', 10, 'sample batch size, default: 100')
